...
| **Что нас спасёт (идея)** | Короткое объяснение «что можно везти в 2026 и сколько это стоит» | Деньги за машину до отгрузки — в банке клиента (аккредитив), публичный договор, фиксированная комиссия | Цена под ключ по статьям с диапазоном по курсу; фильтр разрешённых машин | Перевод и разбор аукционного листа; для Кореи/Китая — независимый осмотр | Аккредитив клиента в его банке: раскрывается после погрузки по коносаменту на имя клиента; в пути — страховка груза; вторая половина комиссии — после получения машины [ГИПОТЕЗА Г-11] |
...
> CJM-1 переформулирована в S07: часть «страх — главный барьер» → Г-01, защита денег как причина выбора → Г-03, «внесут реальный депозит» → Г-07 (`hypotheses.md` §2).
...
- **Механизм аккредитива клиента с раскрытием по коносаменту** — [ГИПОТЕЗА Г-11] (И2): аккредитив есть у Encar Russia и Terminal A, но условие «раскрытие после погрузки по коносаменту» для нашей модели не проверено; выкуп до погрузки оплачивает экспортёр [ДОПУЩЕНИЕ, changes-log п. 52].
